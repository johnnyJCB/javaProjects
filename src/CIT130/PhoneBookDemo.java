...
import CIT130.PhoneBookEntry; // If PhoneBookEntry is in the same package, no need to import it separately

import java.util.Scanner;

/**
 * There are syntax errors below
...
public class PhoneBookDemo {
    public static void main(String args[]) {
        ...
        // 1. Assign the variable list to an array of PhoneBookEntry objects using the variable
        ...
        for (int i = 0; i < list.length; i++) {
            ...
            /* 2.
             * create a PhoneBookEntry object using the input values
